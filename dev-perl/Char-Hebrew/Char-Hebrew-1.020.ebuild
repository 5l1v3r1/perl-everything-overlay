...
DIST_AUTHOR="INA"
DIST_VERSION="1.02" 
SRC_URI="mirror://cpan/authors/id/I/IN/INA/Char/Hebrew/Char-Hebrew-1.02.tar.gz -> Char-Hebrew-1.02.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Char-Hebrew-1.02 ${WORKDIR}/Char-Hebrew-1.02
}
