...
DIST_AUTHOR="INA"
DIST_VERSION="1.08" 
SRC_URI="mirror://cpan/authors/id/I/IN/INA/Char/GB18030/Char-GB18030-1.08.tar.gz -> Char-GB18030-1.08.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Char-GB18030-1.08 ${WORKDIR}/Char-GB18030-1.08
}
