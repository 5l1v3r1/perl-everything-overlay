...
DIST_AUTHOR="INA"
DIST_VERSION="1.02" 
SRC_URI="mirror://cpan/authors/id/I/IN/INA/Char/Arabic/Char-Arabic-1.02.tar.gz -> Char-Arabic-1.02.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Char-Arabic-1.02 ${WORKDIR}/Char-Arabic-1.02
}
