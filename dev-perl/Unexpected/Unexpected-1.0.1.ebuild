...
DIST_AUTHOR="PJFL"
DIST_VERSION="1.0.1" 
SRC_URI="mirror://cpan/authors/id/P/PJ/PJFL/unexpected/Unexpected-1.0.1.tar.gz -> Unexpected-1.0.1.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Unexpected-1.0.1 ${WORKDIR}/Unexpected-1.0.1
}
