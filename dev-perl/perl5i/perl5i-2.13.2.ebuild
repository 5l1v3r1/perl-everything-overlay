...
DIST_VERSION="2.13.2" 
SRC_URI="mirror://cpan/authors/id/M/MS/MSCHWERN/perl5i-v2.13.2.tar.gz -> perl5i-2.13.2.tar.gz"
inherit perl-module
...
RDEPEND="
	...
	>=dev-perl/Hash-StoredIterator-0.007
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/perl5i-v2.13.2 ${WORKDIR}/perl5i-2.13.2
}
