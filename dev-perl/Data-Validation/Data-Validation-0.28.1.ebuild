...
DIST_AUTHOR="PJFL"
DIST_VERSION="0.28.1" 
SRC_URI="mirror://cpan/authors/id/P/PJ/PJFL/data-validation/Data-Validation-0.28.1.tar.gz -> Data-Validation-0.28.1.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Data-Validation-0.28.1 ${WORKDIR}/Data-Validation-0.28.1
}
