...
DIST_AUTHOR="INA"
DIST_VERSION="1.08" 
SRC_URI="mirror://cpan/authors/id/I/IN/INA/Char/Cyrillic/Char-Cyrillic-1.08.tar.gz -> Char-Cyrillic-1.08.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Char-Cyrillic-1.08 ${WORKDIR}/Char-Cyrillic-1.08
}
