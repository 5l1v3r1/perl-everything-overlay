...
DIST_AUTHOR="INA"
DIST_VERSION="0.08" 
SRC_URI="mirror://cpan/authors/id/I/IN/INA/Modern/Open/Modern-Open-0.08.tar.gz -> Modern-Open-0.08.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Modern-Open-0.08 ${WORKDIR}/Modern-Open-0.08
}
