...
DIST_VERSION="0.0.11" 
SRC_URI="mirror://cpan/authors/id/E/EW/EWILHELM/dotReader-v0.0.11.tar.gz -> dotReader-0.0.11.tar.gz"
inherit perl-module
...
RDEPEND="
	...
	>=dev-perl/Class-Accessor-Classy-0.001.001
	dev-perl/DBD-SQLite
	dev-perl/DBI
	dev-perl/Data-GUID
	dev-perl/File-NCopy
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/dotReader-v0.0.11 ${WORKDIR}/dotReader-0.0.11
}
