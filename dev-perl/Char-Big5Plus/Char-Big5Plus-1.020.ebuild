...
DIST_AUTHOR="INA"
DIST_VERSION="1.02" 
SRC_URI="mirror://cpan/authors/id/I/IN/INA/Char/Big5Plus/Char-Big5Plus-1.02.tar.gz -> Char-Big5Plus-1.02.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Char-Big5Plus-1.02 ${WORKDIR}/Char-Big5Plus-1.02
}
