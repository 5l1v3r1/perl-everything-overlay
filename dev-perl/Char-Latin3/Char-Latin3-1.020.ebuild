...
DIST_AUTHOR="INA"
DIST_VERSION="1.02" 
SRC_URI="mirror://cpan/authors/id/I/IN/INA/Char/Latin3/Char-Latin3-1.02.tar.gz -> Char-Latin3-1.02.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Char-Latin3-1.02 ${WORKDIR}/Char-Latin3-1.02
}
