...
DIST_AUTHOR="PJFL"
DIST_VERSION="0.31.1" 
SRC_URI="mirror://cpan/authors/id/P/PJ/PJFL/ipc-srlock/IPC-SRLock-0.31.1.tar.gz -> IPC-SRLock-0.31.1.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/IPC-SRLock-0.31.1 ${WORKDIR}/IPC-SRLock-0.31.1
}
