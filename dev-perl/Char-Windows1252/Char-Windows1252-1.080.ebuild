...
DIST_AUTHOR="INA"
DIST_VERSION="1.08" 
SRC_URI="mirror://cpan/authors/id/I/IN/INA/Char/Windows1252/Char-Windows1252-1.08.tar.gz -> Char-Windows1252-1.08.tar.gz"
inherit perl-module
...
src_unpack(){
        unpack ${A}
        mv ${WORKDIR}/Char-Windows1252-1.08 ${WORKDIR}/Char-Windows1252-1.08
}
